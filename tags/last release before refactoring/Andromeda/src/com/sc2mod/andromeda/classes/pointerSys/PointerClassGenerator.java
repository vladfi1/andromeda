...
import com.sc2mod.andromeda.classes.indexSys.IndexVirtualCallTableGenerator;
...
public class PointerClassGenerator extends ClassGenerator {
	...
	public PointerClassGenerator(Environment env, CodeGenVisitor c,INameProvider nameProvider,Options options) {
