...
public class AndromedaSymbol extends java_cup.runtime.Symbol {
  //private int line;
  //private int column;

  public AndromedaSymbol(int type, int start, int end) {
    this(type, start, end, null);
  }

  public AndromedaSymbol(int type, int start, int end, Object value) {
