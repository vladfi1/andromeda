...
public class ParameterList extends SyntaxNode {
  ...
  public ParameterList(Parameter anItem) {
    this();
    append(anItem);
  }

  public ParameterList append(Parameter anItem) {
  ...
  public Parameter elementAt(int index) {
    return (Parameter) items.elementAt(index);
  }

  public void setElementAt(Parameter item, int index) {
    item.setParent(this);
    items.setElementAt(item, index);
  }

  public void insertElementAt(Parameter item, int index) {
    item.setParent(this);
  ...
  public String toString(String tab) {
    ...
    int size = items.size();
    for (int i = 0; i < size; i++) {
      buffer.append(((Parameter) items.elementAt(i)).toString("  "+tab));
      buffer.append("\n");
    }
    buffer.append(tab);
    buffer.append(") [ParameterList]");
