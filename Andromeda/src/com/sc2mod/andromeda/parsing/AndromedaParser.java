...
public class AndromedaParser extends Parser {
	...
	private AndromedaFile parse(AndromedaSource f, int inclusionType) throws Exception{
	...
	AndromedaFile parse(AndromedaSource f, AndromedaFile fold, int inclusionType) throws Exception{
