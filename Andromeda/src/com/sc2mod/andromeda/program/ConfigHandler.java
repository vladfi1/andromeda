...
public class ConfigHandler {
	...
	public ConfigHandler(File path, boolean caseSensitive) throws FileNotFoundException, IOException {
		this(new FileReader(path), caseSensitive);
	}
	
	public ConfigHandler(InputStream input, boolean caseSensitive) throws FileNotFoundException, IOException {
		this(new InputStreamReader(input), caseSensitive);
	}

	public ConfigHandler(Reader input, boolean caseSensitive) throws FileNotFoundException, IOException {
	...
	public String getPropertyString(String section, String key, String defaultValue) {
		if(defaultValue == null) throw new Error("default value may not be null");
