...
public class CodeGenExpressionVisitor extends VisitorAdaptor {
	...
	public CodeGenExpressionVisitor(CodeGenVisitor codeGenVisitor, Environment env,
			Options options) {
	...
	public void visit(LiteralExpression literalExpression) {
		...
		case LiteralType.NULL:
			...
			break;
		default:
			throw new CompilationError(l,"Unknown literal type: " + l.getType());
		}
	...
	public void visit(Assignment assignment) {
		...
		curExprBuffer.append(CodegenUtil.getAssignOp(assignment.getOperator(), options.whitespacesInExprs));
	...
	public void visit(BinaryExpression binaryExpression) {
		...
		curExprBuffer.append(CodegenUtil.getBinaryOp(binaryExpression.getOperator(), options.whitespacesInExprs));
	...
	public void visit(UnaryExpression unaryExpression) {
		...
		default: throw new CompilationError(unaryExpression,"Unkonwn unary operator type: " + op);
		}
	}
		...
		case Invocation.TYPE_METHOD:
			...
			switch(invocationType){
				...
				case AccessType.EXPRESSION:
					...
					break;
				default:
					throw new CompilationError("Unsupported invocation type!");
			}
		}
