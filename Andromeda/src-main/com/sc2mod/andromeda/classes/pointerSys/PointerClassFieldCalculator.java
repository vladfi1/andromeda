 ...
 *
 */
public class PointerClassFieldCalculator extends ClassFieldCalculator {

	public PointerClassFieldCalculator(TypeProvider tp, INameProvider snv) {
		super(tp,snv);
	}
	...
	protected ArrayList<FieldDecl> generateImplicitFields(Class c) {
		...
		result.add(createField(c,typeProvider.getSystemClass("Class"),"__type"));
		return result;
	}
