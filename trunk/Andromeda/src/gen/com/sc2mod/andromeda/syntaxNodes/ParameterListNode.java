...
public class ParameterListNode extends SyntaxNode {
  ...
  public ParameterListNode(ParameterNode anItem) {
    this();
    append(anItem);
  }

  public ParameterListNode append(ParameterNode anItem) {
  ...
  public ParameterNode elementAt(int index) {
    return (ParameterNode) items.elementAt(index);
  }

  public void setElementAt(ParameterNode item, int index) {
    item.setParent(this);
    items.setElementAt(item, index);
  }

  public void insertElementAt(ParameterNode item, int index) {
    item.setParent(this);
  ...
  public boolean contains(ParameterNode item) {
    int size = items.size();
  ...
  public int indexOf(ParameterNode item) {
  ...
  public String toString(String tab) {
    ...
    buffer.append(tab);
    buffer.append("ParameterListNode (\n");
    int size = items.size();
    for (int i = 0; i < size; i++) {
      buffer.append(((ParameterNode) items.elementAt(i)).toString("  "+tab));
      buffer.append("\n");
    }
    buffer.append(tab);
    buffer.append(") [ParameterListNode]");
