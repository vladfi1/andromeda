...
public class AnnotationListNode extends SyntaxNode {

  private Vector items;
  private SyntaxNode parent;

  public AnnotationListNode() {
    items = new Vector();
  }

  public AnnotationListNode(AnnotationNode anItem) {
    this();
    append(anItem);
  }

  public AnnotationListNode append(AnnotationNode anItem) {
  ...
  public AnnotationNode elementAt(int index) {
    return (AnnotationNode) items.elementAt(index);
  }

  public void setElementAt(AnnotationNode item, int index) {
    item.setParent(this);
    items.setElementAt(item, index);
  }

  public void insertElementAt(AnnotationNode item, int index) {
    item.setParent(this);
  ...
  public boolean contains(AnnotationNode item) {
    int size = items.size();
  ...
  public int indexOf(AnnotationNode item) {
  ...
  public String toString(String tab) {
    ...
    buffer.append(tab);
    buffer.append("AnnotationListNode (\n");
    int size = items.size();
    for (int i = 0; i < size; i++) {
      buffer.append(((AnnotationNode) items.elementAt(i)).toString("  "+tab));
      buffer.append("\n");
    }
    buffer.append(tab);
    buffer.append(") [AnnotationListNode]");
  ...
  public void childrenAccept(VoidVisitor visitor) {
    ...
    AnnotationNode val = elementAt(i);
