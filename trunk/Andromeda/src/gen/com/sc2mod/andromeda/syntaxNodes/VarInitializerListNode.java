...
public class VarInitializerListNode extends SyntaxNode {

  private Vector items;
  private SyntaxNode parent;

  public VarInitializerListNode() {
    items = new Vector();
  }

  public VarInitializerListNode(Object anItem) {
    this();
    append(anItem);
  }

  public VarInitializerListNode append(Object anItem) {
  ...
  public String toString(String tab) {
    ...
    buffer.append(tab);
    buffer.append("VarInitializerListNode (\n");
    int size = items.size();
    for (int i = 0; i < size; i++) {
