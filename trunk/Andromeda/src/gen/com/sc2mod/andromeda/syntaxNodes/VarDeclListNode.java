...
public class VarDeclListNode extends SyntaxNode {
  ...
  public VarDeclListNode(VarDeclNode anItem) {
    this();
    append(anItem);
  }

  public VarDeclListNode append(VarDeclNode anItem) {
  ...
  public VarDeclNode elementAt(int index) {
    return (VarDeclNode) items.elementAt(index);
  }

  public void setElementAt(VarDeclNode item, int index) {
    item.setParent(this);
    items.setElementAt(item, index);
  }

  public void insertElementAt(VarDeclNode item, int index) {
    item.setParent(this);
  ...
  public boolean contains(VarDeclNode item) {
    int size = items.size();
  ...
  public int indexOf(VarDeclNode item) {
  ...
  public String toString(String tab) {
    ...
    int size = items.size();
    for (int i = 0; i < size; i++) {
      buffer.append(((VarDeclNode) items.elementAt(i)).toString("  "+tab));
      buffer.append("\n");
    }
    buffer.append(tab);
    buffer.append(") [VarDeclListNode]");
