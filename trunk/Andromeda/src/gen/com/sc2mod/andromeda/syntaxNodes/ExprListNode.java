...
public class ExprListNode extends SyntaxNode {
  ...
  public ExprListNode(ExprNode anItem) {
    this();
    append(anItem);
  }

  public ExprListNode append(ExprNode anItem) {
  ...
  public ExprNode elementAt(int index) {
    return (ExprNode) items.elementAt(index);
  }

  public void setElementAt(ExprNode item, int index) {
    item.setParent(this);
    items.setElementAt(item, index);
  }

  public void insertElementAt(ExprNode item, int index) {
    item.setParent(this);
  ...
  public boolean contains(ExprNode item) {
    int size = items.size();
  ...
  public int indexOf(ExprNode item) {
  ...
  public String toString(String tab) {
    ...
    int size = items.size();
    for (int i = 0; i < size; i++) {
      buffer.append(((ExprNode) items.elementAt(i)).toString("  "+tab));
      buffer.append("\n");
    }
    buffer.append(tab);
    buffer.append(") [ExprListNode]");
