 ...
 *  </dl>
 *
 * @see     com.sc2mod.andromeda.parser.cup.Symbol
 * @see     com.sc2mod.andromeda.parser.cup.Symbol
 * @see     com.sc2mod.andromeda.parser.cup.VirtualParseStack
...
public abstract class LRParser {
	 ...
	 * 
	 * @see com.sc2mod.andromeda.parser.cup.LRParser#get_action
	 */
	 ...
	 * 
	 * @see com.sc2mod.andromeda.parser.cup.LRParser#get_reduce
	 */
	...
	protected SymbolStack stack = new SymbolStack();
	...
	public void setScanner(Scanner s) {
		_scanner = s;
		symbolFactory = s.getSymbolFactory();
	}
	...
	public IParserHook hook = IParserHook.DO_NOTHING;

	public IParserHook getHook() {
		return hook;
	}

	public void setHook(IParserHook hook) {
		this.hook = hook;
	}
	 ...
	 */
	public abstract Symbol do_action(int act_num, int tos)
