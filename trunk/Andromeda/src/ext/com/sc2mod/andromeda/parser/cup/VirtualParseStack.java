 ...
 *
 * @see     com.sc2mod.andromeda.parser.lr_parser$old
...
public class VirtualParseStack {
  ...
  public VirtualParseStack(SymbolStack shadowing_stack) throws java.lang.Exception
    {
      /* sanity check */
   ...
   *  unmodified.
   */
  protected SymbolStack real_stack;
