...
public class FunctionSet {
	...
	private static Function chooseFunctionForInvocation(LinkedList<Function> functions, FileScope scope,boolean wantNative){
	...
	public Function resolveInvocation(FileScope scope,SyntaxNode where, String name, Signature s, boolean wantNative) {
